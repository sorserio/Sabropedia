    ...
    <main>
        <section class="p-form">
            <div class="login-box">
                ...
                <form:form action="/procesa/recuperarLocal" method="post" modelAttribute="loginUsuarioComercio">
					...
					<form:input path="contraseña" type="password" placeholder="Ingresa tu nueva contraseña"/>
