...
<body>
    ...
    <div class="nav-bar">
        <div class="slogan">Nunca está de más un café calentito!</div>
    ...
    <main class="bodyCards">
        <section class="column">
        	<a class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/cafeteria.jpg" alt="café con trozo de pastel">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/amapola.png" alt="logo Cafetería Amapola">
                            <h3>Cafetería Amapola</h3>
                        </div>
                        <div class="mark">
            ...
            <a class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/coffice.png" alt="Café con croissant ">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/coffice.png" alt="logo de San Jorge Cafeterías">
                            <h3>Coffice</h3>
                        </div>
                        <div class="mark">
            ...
            <a class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/loscorazones.png" alt="Café con alfajores">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/loscorazones.png" alt="logo de Cafetería Los Corazones">
                            <h3>Cafetería Los Corazones</h3>
                        </div>
                        <div class="mark">
        ...
        <section class="column">
            <a  class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/coffee-place.png" alt="Café espumoso de gatitos">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/coffe-place.png" alt="Logo de Coffee Place">
                            <h3>Coffee Place</h3>
                        </div>
                        <div class="mark">
            ...
            <a class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/kaffe.png" alt="Café con Laptop">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/kaffe.png" alt="logo de cafetería Kaffe">
                            <h3>Kaffe</h3>
                        </div>
                        <div class="mark">
                            <span><i class="fa fa-star"></i> 4.4</span>
            ...
            <a class="card-link">
                <div class="card">
                    <img class="local-img" src="./images/local/sical.png" alt="Capuccino con trozo de pastel">
                    <div class="category">
                        <span class="cat">CAFETERÍA</span>
                    </div>
                    <div class="logo-name-mark">
                        <div class="logo-name">
                            <img src="./images/logo/sical.png" alt="logo de Sical Café">
                            <h3>Sical Café</h3>
                        </div>
                        <div class="mark">
